...
<@layout title="${sheet.title!'Links'} | ${options.blog_title!}" keywords="${options.seo_keywords!}" description="${options.seo_description!}">
    <main class="mx-auto" id="container">
        <header class="bg-cover post-cover">
            <#if settings.links_placeholder?? && settings.links_placeholder!=''>
                <div class="cover-bg">
                    <img src="${settings.links_placeholder!}" class="z-auto"
                         alt="${sheet.title!'Links'}">
                </div>
            <#else>
            ...
            <div class="cover-content flex justify-center">
                ...
                <div class="inner flex flex-col justify-center">
                    <p class="cover-title text-base md:text-4xl lg:text-4xl xl:text-5xl">${sheet.title!'Links'}</p>
                </div>
            </div>
        </header>
