...
<@layout title="${settings.achieve_title!'Archive'} | ${options.blog_title!} " keywords="${options.seo_keywords!}" description="${options.seo_description!}">
        ...
        <header class="bg-cover post-cover">
            <#if settings.archives_patternimg?? && settings.archives_patternimg!=''>
                <div class="cover-bg">
                    <img src="${settings.archives_patternimg!}" class="z-auto"
                         alt="${settings.achieve_title!'Archive'}">
                </div>
            <#else>
            ...
            <div class="cover-content flex justify-center">
                ...
                <div class="inner flex flex-col justify-center">
                    <p class="cover-title text-base md:text-4xl lg:text-4xl xl:text-5xl">${settings.achieve_title!'Archive'}</p>
                </div>
            </div>
        </header>
                ...
                <#list archives as archive>
                    <section class="arch-year">
                        ...
                        <div class="relative pl-12">
                            <header class="absolute mh-hd bg-fff af-bg-fff mh-bg "> ${archive.month!} month</header>
                            <span class="">
