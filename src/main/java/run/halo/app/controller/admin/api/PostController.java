...
public class PostController {
	...
	public PostController(PostService postService, AbstractStringCacheStore cacheStore, OptionService optionService) {
	...
	public PostDetailVO createBy(@Valid @RequestBody PostParam postParam,
		...
		return postService.createBy(post, postParam.getTagIds(), postParam.getCategoryIds(), postParam.getPostMetas(),
				autoSave);
	}
	...
	public BasePostMinimalDTO updateStatusBy(@PathVariable("postId") Integer postId,
	...
	public BasePostDetailDTO updateDraftBy(@PathVariable("postId") Integer postId,
	...
	@GetMapping("updatesequence/{table}")
	@ApiOperation("Updates sequence")
	public Object updateStatusInBatch(@PathVariable(name = "table") String table) {
		return postService.updateSequence(table);
	}
}
