...
public class PostModel {
    ...
    public String content(Post post, String token, Model model) {
        ...
        if (StringUtils.isEmpty(token)) {
            ...
            // verify token
            String cachedToken = cacheStore.getAny(token, String.class).orElseThrow(() -> new ForbiddenException("You do not have access to this article"));
...
//        System.err.println(postService.convertToDetailVo(postService.getPrevPost(post).get()));
