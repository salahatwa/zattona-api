...
public class SheetServiceImpl extends BasePostServiceImpl<Sheet> implements SheetService {
    ...
    public Sheet getBySlug(String slug) {
        ...
        return sheetRepository.getBySlug(slug).orElseThrow(() -> new NotFoundException("Can't find information on this page").setErrorData(slug));
    }
    ...
    public Sheet getBy(PostStatus status, String slug) {
        ...
        return postOptional.orElseThrow(() -> new NotFoundException("Can't find information on this page").setErrorData(slug));
    }
