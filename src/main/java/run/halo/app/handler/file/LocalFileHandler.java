...
//    	try {
//			Cloudinary cloudinary = new Cloudinary(ObjectUtils.asMap("cloud_name", "hylvjoq6v", "api_key",
//					"793526491392753", "api_secret", "EwfAEiVExn9ZmFDz0kHx34UG520"));
//
//			Map map = cloudinary.uploader().upload(convertMultiPartToFile(file), ObjectUtils.emptyMap());
//
