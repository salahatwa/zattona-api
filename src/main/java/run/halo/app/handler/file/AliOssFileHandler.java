...
public class AliOssFileHandler implements FileHandler {
    ...
    public @NotNull UploadResult upload(@NotNull MultipartFile file) {
        ...
        try {
            ...
            if (putObjectResult == null) {
                throw new FileOperationException("Upload Attachment " + file.getOriginalFilename() + " 到阿里云失败 ");
            }
            ...
            throw new FileOperationException("Upload Attachment " + file.getOriginalFilename() + " 到阿里云失败 ", e).setErrorData(file.getOriginalFilename());
        } finally {
            ossClient.shutdown();
        }
    }
    ...
    public void delete(@NotNull String key) {
        ...
        try {
            ...
            throw new FileOperationException("annex " + key + " Failed to delete from Alibaba Cloud", e);
        } finally {
            ossClient.shutdown();
        }
    }
