...
public class TwoFactorAuthUtils {
    ...
    public static String generateTFACode(String tfaKey) {
        try {
            ...
            throw new AuthenticationException("Two-step verification code generation exception");
        }
    }
    ...
    public static void validateTFACode(String tfaKey, String tfaCode) {
        try {
            ...
            if (!result) throw new BadRequestException("Two-step verification code verification error, please confirm whether the time is synchronized");
