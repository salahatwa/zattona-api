...
<@layout title="${settings.links_title!'Links'} | ${options.blog_title!}" keywords="${options.seo_keywords!}" description="${options.seo_description!}">
    <main class="mx-auto" id="container">
        <header class="bg-cover post-cover">
            <#if settings.links_patternimg?? && settings.links_patternimg!=''>
                <div class="cover-bg">
                    <img src="${settings.links_patternimg!}" class="z-auto"
                         alt="${settings.links_title!'Links'}">
                </div>
            <#else>
            ...
            <div class="cover-content flex justify-center">
                ...
                <div class="inner flex flex-col justify-center">
                    <p class="cover-title text-base md:text-4xl lg:text-4xl xl:text-5xl">${settings.links_title!'Links'}</p>
                </div>
            </div>
        </header>
